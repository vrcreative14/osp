...
class Store(models.Model):
    ...
    latitude = models.CharField(max_length=20, default='26.8467° N', blank=True, null=True)
    longitude = models.CharField(max_length=20, default='80.9462° E', blank=True, null=True)
